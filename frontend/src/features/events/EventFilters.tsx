    ...
    >
      <div className="flex w-full items-center gap-1.5 sm:w-auto">
        <Button
          ...
          className={cn(
            'h-auto shrink-0 px-2 py-1 text-[#666] hover:bg-white/[0.03] hover:text-[#cccccc]',
        ...
        <Input
          ...
          className={cn(
            'h-auto py-1 text-[0.8rem] bg-neutral-950 border-[#333] text-[#cccccc] placeholder:text-[#666] focus-visible:ring-0 transition-all duration-200',
            searchOpen
        ...
        <Button
          ...
          className={cn(
            'relative h-auto shrink-0 px-2 py-1 text-[#666] hover:bg-white/[0.03] hover:text-[#cccccc]',
