...
- Go methods return value-plus-error tuples and sometimes total counts for pagination (`ListSessionsByCWDPage`, `GetTracesPage` in `backend/internal/repository/sqlite/sqlite.go`).
