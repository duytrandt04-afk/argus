...
**Goal:** `EventService` owns: persist events, track session models, broadcast new events to SSE subscribers. Tested with a hand-written mock repo (no mockgen needed).
