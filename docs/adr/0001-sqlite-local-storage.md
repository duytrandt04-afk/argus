...
Hooker is a local-first, single-user product for observing AI coding agent activity. It stores
...
- Users can run hooker without a database server or cloud account.
