...
Hooker captures sensitive local development context, including prompts, diffs, file paths, tool
...
Position hooker as a local-first product. The default runtime stores data locally, serves the
